...
setup(
    ...
    description='Configuration Templating Language',  # Optional
    ...
    url='https://github.com/ttt-fifo',  # Optional
    ...
    # above.
    author_email='ttodorov@null.net',  # Optional
